...
namespace PI.src.localization.windows
{
    public class StatisticalAnalysisStrings
    {
        ...
        {
            public LocalizedString StandardDeviationTitle { get { return new LocalizedString( CurrentLanguage, "StatisticalAnalysis_Ui_StandardDeviation_StandardDeviation" ); } }
            ...
            public LocalizedString StandardDeviationSaturation { get { return new LocalizedString( CurrentLanguage, "StatisticalAnalysis_Ui_StandardDeviation_Deform" ); } }
            ...
            public LocalizedString PreviewTitle { get { return new LocalizedString( CurrentLanguage, "StatisticalAnalysis_Ui_Preview_Preview" ); } }
